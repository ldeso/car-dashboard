...
QRectF voyantsYoucef::boundingRect() const
{
    return QRectF(-600, -400, 1200, 800);
}
void voyantsYoucef::flashing()
{
    if (clignotant==1){
     clignotant=0;
    }
...
void voyantsYoucef::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    ...
    if(getValue()==2)
    {
        QPixmap img1(":/new/icones/Icones/ClignottantDroit.png");
        QPixmap img2=img1.scaled(50,50);
        QRadialGradient grad1(QPointF(0,-95),15);
        grad1.setColorAt(0, QColor(0,255,0));
        grad1.setColorAt(1, QColor(0,0,0,120));
        ...
        QPixmap img3(":/new/icones/Icones/ClignottantGauche.png");
...
//    QPixmap img1(":/new/icones/Icones/Warning.png");
...
//    painter->setBrush(brush);
//    painter->setOpacity(clignotant);
//    painter->drawPixmap(-15,-295,50,50,img2);
