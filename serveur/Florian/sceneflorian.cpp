...
{
    this->position = new FlorianVoyant(QPixmap(QString(":/new/prefix1/Florian/voyant/position.jpeg")));
    this->addItem(this->position);
    this->position->setPos(40, 70);
    this->croisement = new FlorianVoyant(QPixmap(QString(":/new/prefix1/Florian/voyant/croisement.jpg")));
    this->addItem(this->croisement);
    this->croisement->setPos(60, 40);
    this->route = new FlorianVoyant(QPixmap(QString(":/new/prefix1/Florian/voyant/route.jpg")));
    this->addItem(this->route);
    this->route->setPos(110, 40);
    this->brouillardAvant = new FlorianVoyant(QPixmap(QString(":/new/prefix1/Florian/voyant/brouillardAvant.jpg")));
    this->addItem(this->brouillardAvant);
    this->brouillardAvant->setPos(130, 70);
    this->brouillardArriere = new FlorianVoyant(QPixmap(QString(":/new/prefix1/Florian/voyant/brouillardArriere.jpg")));
    this->addItem(this->brouillardArriere);
    this->brouillardArriere->setPos(130, 100);
    this->noEssence = new FlorianVoyant(QPixmap(QString(":/new/prefix1/Florian/voyant/noEssence.jpg")));
    this->addItem(this->noEssence);
    this->noEssence->setPos(-60, 75);
    this->noEssence->setScale(0.8);
    this->noHuile = new FlorianVoyant(QPixmap(QString(":/new/prefix1/Florian/voyant/noHuile.jpg")));
    ...
    this->refroidissement = new FlorianVoyant(QPixmap(QString("::/new/prefix1/Florian/voyant/refroidissement.jpg")));
    this->addItem(this->refroidissement);
    this->refroidissement->setPos(-260, 100);
    this->batterie = new FlorianVoyant(QPixmap(QString(":/new/prefix1/Florian/voyant/batterie.jpg")));
    this->addItem(this->batterie);
    this->batterie->setPos(-260, 70);
    this->warning = new FlorianVoyant(QPixmap(QString(":/new/prefix1/Florian/voyant/warning.jpg")));
    this->addItem(this->warning);
    this->warning->setPos(-70, -30);
    this->warning->setScale(1.4);
    this->ceinture = new FlorianVoyant(QPixmap(QString(":/new/prefix1/Florian/voyant/ceinture.jpg")));
    this->addItem(this->ceinture);
    this->ceinture->setPos(-230, 40);
    this->noCeinture = new FlorianVoyant(QPixmap(QString("::/new/prefix1/Florian/voyant/noCeinture.jpg")));
